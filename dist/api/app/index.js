...
const productCreateModule = __importStar(require("./product-create"));
const orderCreateModule = __importStar(require("./order-create"));
const productListModule = __importStar(require("./products-list"));
const buildServices = (dependencies) => {
